/*
        ...
        TRABALHO 2
        - ADAPTACAO DO "PROBLEMA DO BANHEIRO UNICO" (VER DETALHES NA
   ESPECIFICACAO)
        ...
        REGRAS
        - VOCE PODE ADICIONAR CODIGO A VONTADE DESDE QUE SEJA A PARTIR DA LINHA
   COM O COMENTARIO "TODO"
        ...
        - O NUMERO DE PETS NA AREA DE COMIDA NAO PODE ULTRAPASAR O VALOR DA
   MACRO "MAX_PETS"
...
void do_stuff(int const id, char const* kind, char const* action) {
    ...
    std::this_thread::sleep_for(
        std::chrono::microseconds(std::rand() % MAX_SLEEP_US));
